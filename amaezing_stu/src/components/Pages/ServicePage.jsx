        ...
        <div id="services" className="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
            <div className="container xl:max-w-6xl mx-auto px-4">
                <header className="text-center mx-auto mb-12 lg:px-20">
                    <h2 className="text-3xl leading-normal mb-2 font-bold bg-gradient-to-r from-purple-400 to-red-400 bg-clip-text text-transparent ">What We Do</h2>
                    <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 100 60" style={{margin: '0 auto',height: '35px'}} xml:space="preserve">
                        <circle cx="50.1" cy="30.4" r="5" className="stroke-primary" style={{fill: 'transparent','stroke-width': '2','stroke-miterlimit': '10'}}></circle>
                        <line x1="55.1" y1="30.4" x2="100" y2="30.4" className="stroke-primary" style={{'stroke-width': '2','stroke-miterlimit': '10'}}></line>
                        <line x1="45.1" y1="30.4" x2="0" y2="30.4" className="stroke-primary" style={{'stroke-width': '2','stroke-miterlimit': '10'}}></line>
                    </svg>
                ...
                <div className="flex flex-wrap flex-row -mx-4 text-center">
                    <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" style={{visibility: 'visible', 'animation-duration': '1s', 'animation-name': 'fadeInUp'}}>
                        <div className="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:bg-gradient-to-r from-purple-400 to-red-400">
                            ...
                            <p className="text-gray-800">This is a wider card with supporting text below as a natural content.</p>
                        </div>
          
                    </div>
                    <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".1s" style={{visibility: 'visible', 'animation-duration': '1s', 'animation-delay': '0.1s', 'animation-name': 'fadeInUp'}}>
                        <div className="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:bg-gradient-to-r from-purple-400 to-red-400">
                            <div className="inline-block text-gray-900 mb-4">
                    ...
                    <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" data-wow-duration="1s" data-wow-delay=".3s" style={{visibility: 'visible', 'animation-duration': '1s', 'animation-delay': '0.3s', 'animation-name': 'fadeInUp'}}>
                        <div className="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:bg-gradient-to-r from-purple-400 to-red-400">
                            <div className="inline-block text-gray-900 mb-4">
                    ...
                    <div className="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp" hodata-wow-duration="1s" data-wow-delay=".3s" style={{visibility: 'visible', 'animation-duration': '1s', 'animation-delay': '0.3s', 'animation-name': 'fadeInUp'}}>
                        <div className="py-8 px-12 mb-12 bg-gray-50 border-b border-gray-100 transform transition duration-300 ease-in-out hover:-translate-y-2 hover:bg-gradient-to-r from-purple-400 to-red-400">
                            <div className="inline-block text-gray-900 mb-4">
